 ...
 * with no wage tax plus fourteen more whose snapshot carries no per-dependent
 ...
 * of those fourteen states — California's dependent exemption credit, South
 * Carolina's dependent exemption under S.C. Code 12-6-1140 — do have a
 * provision we have not modelled, and claiming the state gives nothing would
