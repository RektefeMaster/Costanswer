...
const hours: JobRecipe['sources'][string] = {
  ...
  rationale: '16 hours of a two-person HVAC crew per split-system replacement. No licensed nationwide production-rate file is used.',
  confidenceImpact: 'lowers_to_medium',
  reviewedBy: REVIEWED_BY,
  reviewedAt: REVIEWED_AT,
};

export const hvacReplacement: JobRecipe = {
  ...
  materials: [{ componentId: 'split-system', quantityPerUnit: sv(1, 'qty'), wastePercent: sv(0, 'qty'), critical: true }],
  ...
  sources: {
    ...SHARED_SOURCES,
    hours,
    qty: { kind: 'model_assumption', rationale: 'One 3-ton coil-only split plus a typical gas furnace per recipe unit. Tonnage scales this equipment line from the 3-ton EIA baseline.', confidenceImpact: 'none', reviewedBy: REVIEWED_BY, reviewedAt: REVIEWED_AT },
    'equip-hours': hours,
