...
export const JOB_CATALOG: Record<JobId, JobPublicMeta> = {
  'hvac-replacement': {
    ...
    description: 'How much does a new residential HVAC system cost? CostAnswer range for a split system (outdoor AC plus indoor furnace/air handler), using HVAC mechanic wages and named crew time.',
    tradeLabel: 'HVAC',
    unitLabel: 'systems',
    ...
    searchTerms: ['hvac replacement cost', 'ac replacement cost', 'new furnace and ac cost', 'how much to replace hvac', 'central air replacement cost'],
  },
  'water-heater-replacement': {
    jobId: 'water-heater-replacement',
    title: 'How much does a water heater replacement cost?',
    shortTitle: 'Water heater',
    description: 'How much does a water heater replacement cost? CostAnswer range for swapping a residential tank, using plumber wages and named install time. Equipment is EIA’s typical 40-gallon gas or 36-gallon electric tank.',
    tradeLabel: 'Plumbing',
    unitLabel: 'heaters',
  ...
  'fence-install': {
    ...
    searchTerms: ['fence installation cost', 'cost to install a fence', 'privacy fence cost per foot', 'how much does a fence cost', 'wood fence cost'],
  },
  'concrete-driveway': {
    ...
    searchTerms: ['concrete driveway cost', 'how much for a concrete driveway', 'driveway pour cost', 'cost to pour a driveway', 'concrete driveway price per square foot'],
  },
  'interior-painting': {
  ...
  'bathroom-remodel': {
    ...
    searchTerms: ['bathroom remodel cost', 'bathroom renovation cost', 'gut bathroom cost', 'how much to remodel a bathroom', 'full bathroom remodel cost'],
  },
  'kitchen-remodel': {
    jobId: 'kitchen-remodel',
    title: 'How much does a kitchen remodel cost?',
    shortTitle: 'Kitchen remodel',
    description: 'How much does a kitchen remodel cost? CostAnswer range for a same-layout refresh: stock base and wall cabinets, a drop-in sink, ceramic floor tile, and paint. Countertops, appliances, and layout changes are not priced. Composite recipes start at low confidence.',
    tradeLabel: 'Remodeling',
    unitLabel: 'kitchens',
    scope: { id: 'units', label: 'Kitchens', hint: 'Count complete same-layout kitchen refreshes. Countertops and appliances are outside this recipe.', min: 1, max: 2, step: 1, defaultValue: 1 },
    modifiers: [
      { id: 'size', label: 'Size', defaultOptionId: 'standard', options: [{ id: 'small', label: 'Small galley' }, { id: 'standard', label: 'Standard (~10×12)' }, { id: 'large', label: 'Large / with island run' }] },
      { id: 'finish', label: 'Cabinet finish', defaultOptionId: 'stock', options: [{ id: 'stock', label: 'Stock shaker' }, { id: 'mid', label: 'Mid upgrade' }] },
      { id: 'layout', label: 'Layout', defaultOptionId: 'same', options: [{ id: 'same', label: 'Same layout' }, { id: 'move', label: 'Move plumbing' }] },
    ],
    searchTerms: ['kitchen remodel cost', 'kitchen remodeling cost', 'how much does a kitchen remodel cost', 'average kitchen remodel cost', 'cost to remodel a kitchen'],
  },
  'heat-pump-replacement': {
