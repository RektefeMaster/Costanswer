...
export const WAGE_UI = {
  ...
  p10Note: localized({ 'en-US': 'Entry and lowest-paid', 'es-US': 'Nivel inicial y salarios base' }),
  ...
  meanNote: localized({ 'en-US': 'The average, pulled up by the top', 'es-US': 'El promedio, elevado por los sueldos más altos' }),
  ...
  takeHomeTitle: localized({ 'en-US': 'What lands in the bank', 'es-US': 'Lo que llega a la cuenta bancaria (sueldo neto)' }),
  ...
  runOwn: localized({ 'en-US': 'Run your own salary and filing status →', 'es-US': 'Calcule su propio sueldo y deducciones →' }),
