...
export const MARKETPLACE_PLANS_EDITORIAL: ToolEditorial[] = [{
  ...
  guide: {
    ...
    sections: [
      { heading: 'The number a premium comparison hides', paragraphs: [
        'Every Marketplace plan has an out-of-pocket maximum: a legal ceiling on what you pay for covered in-network care in a year. Once you reach it, the plan pays everything else it covers. This page adds the highest maximum filed at each metal in your county to the cheapest premium at that metal, because the published file does not pair those two. The figure is a bound, not one plan’s bill.',
  ...
  faq: [
    ...
    { question: 'Is a Bronze plan cheaper than a Silver plan?', answer: ['On premium, almost always. Over a year in which you need care, often not: Bronze carries a much higher deductible and a higher out-of-pocket maximum, so the most it can cost you is greater. The table shows the cheapest premium against the highest maximum at that metal, a bound rather than one plan’s own ceiling.'] },
