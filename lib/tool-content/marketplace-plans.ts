...
export const MARKETPLACE_PLANS_EDITORIAL: ToolEditorial[] = [{
  ...
  faq: [
    { question: 'How much is health insurance in my area?', answer: ['Enter your ZIP code and the ages of everyone enrolling. The page reads the premiums filed with CMS for your county and shows the cheapest plan at each metal level, along with its deductible and out-of-pocket maximum. These are full prices before any premium tax credit.'] },
