...
const supportedEntries: Array<[StateCode, StateTaxPolicy]> = [
  ...
  ['ME', {
    ...
    notes: [
      ...
      'Maine credits, itemized deductions and the additional deduction for age or blindness are not modeled. The $300 dependent exemption tax credit (36 M.R.S. § 5219-SS) is a separate credit with its own phase-out and is not modeled. The starting point is gross wages.',
    ],
  }],
  ['KY', {
    ...meta('KY', {
